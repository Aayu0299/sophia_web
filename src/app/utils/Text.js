export const TEXT = {
  ...
  ADD_NOTE_FOR_CARE_TEAM: "Add Note for Care Team",
  ADD_NOTE: "Add Note",
  YOUR_NOTE: "Your Note",
  NOTE_PLACEHOLDER: "What would you like to ask the Care Team?",
  EXTERNAL_ADD_BUTTON: "Add External Files",
  EXISTING_NOTE: "Existing Notes",
  VIEW_ALL: "VIEW ALL",
  REPLY: "Reply",
  SCHEDULE: "Schedule",
  FAMILY_CHAT: "Family & Friend Chat",
  INVITE_FRIEND: "Invite Friend",
  SEND_INVITE: "I Agree - Send Invite",
  MEDICAL_SHARE: "Medical data sharing consent",
  ABLE_TEXT: "They will be able to",
  INVITE_FAMILY_OR_FRIEND: "Invite Family or Friend",
  RELATIONSHIP_YOU: "Relationship to You",
